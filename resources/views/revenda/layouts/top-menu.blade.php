...
@include('../revenda/layouts/components/top-bar', ['class' => 'top-bar-boxed--top-menu'])
<!-- BEGIN: Top Menu -->
<nav class="top-nav">
  <ul>
    @foreach ($revenda_top_menu as $menuKey => $menu)
      @php
      ...
      @if($access)
        <li>
          <a href="{{ isset($menu['route_name']) ? route($menu['route_name'], $menu['params']) : 'javascript:;' }}" class="{{ $revenda_first_level_active_index == $menuKey ? 'top-menu top-menu--active' : 'top-menu' }}">
          ...
          @if (isset($menu['sub_menu']))
            <ul class="{{ $revenda_first_level_active_index == $menuKey ? 'top-menu__sub-open' : '' }}">
              @foreach ($menu['sub_menu'] as $subMenuKey => $subMenu)
                ...
                @if($subAccess)
                  <li>
                    ...
                    @if (isset($subMenu['sub_menu']))
                      <ul class="{{ $revenda_second_level_active_index == $subMenuKey ? 'top-menu__sub-open' : '' }}">
