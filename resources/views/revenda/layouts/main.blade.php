  ...
  <body class="py-5 md:py-0">
    ...
    @switch($layout_scheme)
      @case('top-menu')
        ...
        @break
      @case('simple-menu')
        @include('revenda.layouts.simple-menu')
        @break
      @default
        @include('revenda.layouts.side-menu')
    @endswitch

    {{-- <div class="invisible  xl:visible">
      @include('./revenda/layouts/components/layout-mode-switcher')
      @include('./revenda/layouts/components/dark-mode-switcher')
      @include('./revenda/layouts/components/main-color-switcher')
    </div> --}}

    {{-- <div class="sm:visible xl:invisible"> --}}
      @include('./revenda/layouts/components/mobile-mode-switcher')
    {{-- </div> --}}
